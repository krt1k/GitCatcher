...
sendLambda() {
    ...
    curl -X POST -H "Content-Type: application/json" -d "{\"commitHash\":\"$TEST\",\"userEmail\":\"user@example.com\",\"status\":\"done\"}" https://lplfmenj2xgcjodwtlicbr2d5i0cobnl.lambda-url.us-east-1.on.aws/
